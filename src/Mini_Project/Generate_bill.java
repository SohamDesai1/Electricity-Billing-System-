    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            ...
            if (rs.next()) {
                ...
                ta.append("\nSwatch Bharat Cess:            " + rs.getString("SwacchBharatCess") + "\n");
                ta.append("\nCost per unit:                         "+ rs.getInt("Cost_per_unit") + "\n");
                ta.append("\nService charge:                   "+ rs.getInt("service_charge") + "\n");
                ta.append("\nMeter rent:                        "+ rs.getInt("meter_rent") + "\n");
                ta.append("\n-------------------------------------------------------------");
                ta.append("\n");
            }
            ...
            if (rs.next()) {
                ...
                ta.append("\n-------------------------------------------------------------");
                ta.append("\n Bill Total Amount :                " + rs.getString(3) + "\n");
                ta.append("\n");
            }
        } catch (Exception e) {
            e.printStackTrace();
